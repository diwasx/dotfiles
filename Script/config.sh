...
mkdir /DriveE/Projects/Git/dotfiles/.config
mkdir /DriveE/Projects/Git/dotfiles/.config/mps-youtube/
...
mkdir /DriveE/Projects/Git/dotfiles/.config/BetterDiscord/
...
mkdir /DriveE/Projects/Git/dotfiles/etc/
